...
- (void)bindAttributeWithName:(const GLchar*)attributeName type:(GLKVertexAttrib)attrType
{
    glBindAttribLocation(_program, attrType, attributeName);
}
...
- (GLuint)uniformLocation:(const GLchar*)uniformName
{
    return glGetUniformLocation(_program, uniformName);
}

- (GLuint)attributesLocation:(const GLchar*)attributeName
{
